class Question {
  ...
  display(){
    ...
    this.question.html("Question:- The mode of nutrition found in fungi is? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Parasitic nutrition " );
    this.option1.position(150, 100);
    this.option2.html("2: Holozoic nutrition" );
    this.option2.position(150, 120);
    this.option3.html("3: Autotrophic nutrition " );
    this.option3.position(150, 140);
    this.option4.html("4: Saprotrophic nutrition" );
